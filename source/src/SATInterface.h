...
//#define CMSAT
    ...
    public:
        ...
        bool solve() { 
            std::cout<<"Entering solve()A of SATInterface.h"<<std::endl;
        ...
        bool solve(const vec_lit_t& assump) { 
            std::cout<<"Entering solve()B of SATInterface.h"<<std::endl;
        ...
        bool solve(Lit x) { 
            std::cout<<"Entering solve()C of SATInterface.h"<<std::endl;
            vec_lit_t assump;
            assump.push(x);
            lbool result = S.solve(assump); 
            if(result.isDef()) {
    ...
    class Solver {
        ...
        bool _solve() { 
            // std::cout<<"Entering solve()D of SATInterface.h"<<std::endl;
    ...
    public:
        ...
        static int var_to_lit(Var v) //Ankit
        {
            return translate(v);
        }
        ...
        bool solve() { 
            std::cout<<"Entering solve()E of SATInterface.h"<<std::endl;
            return _solve();
        }

        bool solve(const vec_lit_t& assump) { 
            // std::cout<<"Entering solve()F of SATInterface.h"<<std::endl;
        ...
        bool solve(Lit x) { 
            // std::cout<<"Entering solve()G of SATInterface.h"<<std::endl;
